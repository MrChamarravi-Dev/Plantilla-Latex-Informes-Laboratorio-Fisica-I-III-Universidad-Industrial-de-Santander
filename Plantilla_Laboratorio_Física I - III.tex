...
\fancyhead[L]{
	\begin{minipage}{0.245\textwidth}
		\includegraphics[width=4.2cm]{Logo-UIS/uis_horizontal.png} % Puede usar uis_horizontal.png que corresponde al logo de color verde o puede usar el logo uis_negro_horizontal.png que sera el logo aprobado de color negro, ambos seran validos de acuerdo a los lineamientos de identidad de marca de la universidad.
	\end{minipage}
